(function(window, document, undefined) {
  ...
  function Steady(opts) {
    ...
    if ( !opts.conditions ) throw new Error('missing condition parameter');
  ...
  Steady.prototype._cb = function() {
    this.processing = false;
    console.log(this.processing, 'process');
  };
